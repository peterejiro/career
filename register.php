            ...
            <div class="spacing black-layer3 opc8">
                ...
                <div class="container">
                    <div class="pg-tp-wrp text-center">
                        <div class="pg-tp-inr">
                            <h1 itemprop="headline">Registration Page</h1>
                            <ol class="breadcrumb">
                    ...
                    <div class="cnt-frm-dta">
                        <div class="row">
                            <div class="col-md-4 col-sm-12 col-lg-4">
                                <div class="cnt-inf">
                                    <h2 itemprop="headline">Register</h2>
                                     </div>
                            </div>
                                ...
                                <div class="cnt-frm">
                                    <form action="script" method="post">
                                        <div class="row mrg10">
                                            ...
                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                <input class="brd-rd3" type="text" name="firstname" placeholder="First Name">
                                            </div> <br>
                                            <div class="col-md-6 col-sm-6 col-lg-6">
                                                <input class="brd-rd3" type="text" name="lastname" placeholder="Last Name">
                                            </div> <br>


                                            <div class="col-md-12 col-sm-12 col-lg-12">
                                                <button class="theme-bg hrz theme-btn brd-rd3" name="register" type="submit">REGISTER</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
